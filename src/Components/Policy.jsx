  ...
  return (
    <div className="max-w-4xl mx-auto p-6 pt-16 mb-16 text-gray-800">
      ...
      <section className="mb-12">
        <p className="mb-4">
          This privacy notice for <strong>Green Tech</strong> (“Company,” “we,” “us,” or “our“),
        ...
        <ul className="list-disc list-inside mb-4 space-y-1 text-gray-700">
          <li>Visit our website at <a href="https://nagreentech.com" className="text-blue-600 underline">https://nagreentech.com</a>, or any website of ours that links to this privacy notice</li>
        ...
        <p>
          ...
          <a href="mailto:greentcstore@gmail.com" className="text-blue-600 underline">
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-blue-800">WHAT INFORMATION DO WE COLLECT?</h2>
        ...
        <ul className="list-decimal list-inside mb-4 space-y-1 text-gray-700">
          <li>Phone Numbers</li>
          <li>Email Address</li>
        ...
        <p className="mb-4">
          ...
          associated with your payment instrument. All payment data is stored by __________. You may
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-blue-800">Cookie Policy</h2>
        <p>
          This Cookie Policy explains how <strong>Green Tech</strong> (“we,” “our,” or “us”) uses
          cookies and similar technologies to recognize you when you visit our website ([Website URL]).
          It explains what these technologies are and why we use them, as well as your rights to control
          their use.
        </p>
      </section>

      {/* Use and Sharing Personal Information Section */}
      <section className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-blue-800">How do we use and share your personal information?</h2>
        <p>
        ...
        <h3 className="font-semibold mt-6 mb-2">Will your information be shared with anyone else?</h3>
        <p>
          ...
          that processes the information on our behalf, following the same strict privacy protection
        ...
        <p className="mb-4">
          ...
          internal research for technological development and demonstration. This is not considered
          to be “selling” of your personal information.
        </p>

        <p className="mb-4">
          Green Tech has not disclosed, sold, or shared any personal information to third parties
          for a business or commercial purpose in the preceding twelve (12) months. Green Tech will
          not sell or share personal information in the future belonging to website visitors, users,
          and other consumers.
        </p>

        <h3 className="font-semibold mt-6 mb-2">Your rights with respect to your personal data</h3>
        ...
        <ul className="list-disc list-inside mb-4 space-y-1 text-gray-700 ml-6">
        ...
        <p className="mb-4">We do not process consumer’s sensitive personal information.</p>

        <h3 className="font-semibold mt-6 mb-2">Verification process</h3>
        <p>
        ...
        <h3 className="font-semibold mt-6 mb-2">Other privacy rights</h3>
        <p>
          You may object to the processing of your personal information. You may request correction
          of your personal data if it is incorrect or no longer relevant, or ask to restrict the
